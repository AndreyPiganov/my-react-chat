...
function RegistrationForm() {
  ...
  const formik = useFormik({initialValues: {nickname: '', password: '', confirmPassword: ''}, validationSchema: Validator.registration().schema, validateOnChange: validateState, validateOnBlur: validateState, onSubmit: async (values, formikBag) => {
    try{
